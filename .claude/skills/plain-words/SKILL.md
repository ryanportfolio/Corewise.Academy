...
plain phrase ships. Canonical editorial rules live in
`.claude/reference/copy-rules.md` (Plain language section); this skill is the
working procedure and the trap list.
