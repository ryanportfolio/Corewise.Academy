...
| Status | Skills |
|---|---|
| Native | `babysit-ci`, `brainstorming`, `bro`, `caveman`, `enhance-prompt`, `forge-repo-ui-skill`, `handoff-audit`, `humanizer`, `plain-words`, `recall`, `unslop`, `verify-this`, `writing`, `writing-plans` |
